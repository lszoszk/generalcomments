...
def compact_document(doc: dict) -> dict:
    ...
    keys = [
        ...
        'caseName', 'caseNameDisplay', 'caseNameSource', 'caseNameConfidence',
        ...
        'rightsKeywords', 'documentLinks', 'countryCode',
        'outcomeDetailed', 'communicationNumbers',
...
def lite_document(doc: dict) -> dict:
    ...
    keys = [
        ...
        'nameConfidence', 'caseName', 'caseNameDisplay', 'caseNameSource', 'caseNameConfidence',
