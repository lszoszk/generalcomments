...
test('D5. citeMenu · 11 formats incl. legal-IL ones → UN footnote copies', async ({ page, browserName }) => {
  ...
  expect(formats).toEqual(['unfn', 'oscola', 'bluebook', 'mcgill', 'apa', 'harvard', 'chicago', 'bibtex', 'ris', 'csl', 'url']);
